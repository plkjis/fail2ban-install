#!/bin/bash
# ==============================================================================
# Fail2ban Manager (Production Final Version 2026 - Debian 12 systemd optimized)
# ==============================================================================
...
EOF
    ...
    journalctl --vacuum-time=180d >/dev/null 2>&1 || true
...
show_banned(){
    systemctl is-active --quiet fail2ban || { warn "Fail2ban未运行"; return; }
    fail2ban-client status sshd >/dev/null 2>&1 || { warn "sshd jail 未启用"; return; }
